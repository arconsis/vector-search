<template>
  <div>
    <span v-for="i in movies.length">
      <b-icon v-if="i-1 >= currentSlide && i-1 < (currentSlide+showSlides)" icon="circle" size="is-small" type="is-success"></b-icon>
      <b-icon v-else @click.native="changeCurrentSlide(i)" icon="circle-outline" size="is-small" type="is-success"></b-icon>
    </span>
